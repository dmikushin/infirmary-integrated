...
if( ${CSHARP_PLATFORM} MATCHES "x64|itanium" )
  ...
  # TODO Apple
  set( csharp_dotnet_framework_dir "/usr/bin" )
endif( )

# Search for .NET versions
string( REPLACE "\\" "/" csharp_dotnet_framework_dir ${csharp_dotnet_framework_dir} )
file( GLOB_RECURSE csharp_dotnet_executables "${csharp_dotnet_framework_dir}/csc${CMAKE_EXECUTABLE_SUFFIX}" )
...
foreach ( csharp_dotnet_executable ${csharp_dotnet_executables} )
  if( csharp_dotnet_valid )
    if( WIN32 )
      ...
      string( REPLACE "/csc${CMAKE_EXECUTABLE_SUFFIX}" "" csharp_dotnet_version_temp ${csharp_dotnet_version_temp} )
    else( )
      # TODO Read from "csc -version" output
      set(csharp_dotnet_version_temp "3.5")
    endif( )
