...
if( WIN32 )
  ...
  if( EXISTS ${csharp_mono_compiler} )
    ...
    elseif(UNIX)
      ...
      execute_process(COMMAND ${PKG_CONFIG_EXECUTABLE} --variable=libdir mono OUTPUT_VARIABLE output_var)
      string(REPLACE "\n" "" output_var "${output_var}")
      set(CSHARP_MONO_FRAMEWORK "${output_var}/mono/")
      unset(output_var)
    endif()
    if( CSHARP_MONO_FRAMEWORK-NOTFOUND )
      set( CSHARP_MONO_FOUND 0 )
    endif()
